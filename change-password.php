...
$title = "Change Password | Automated Resume Builder";
...
<div class="d-flex align-items-center" style="height:100vh">
     <div class="w-100">
        <main class="form-signin w-100 m-auto bg-white shadow rounded">
            <form actions="actions\changepassword.action.php" method="POST">
                ...
                <div class="mb-3">
                    <span class="mb-3 fw-bold"><?php $fn->getSession('email')==""?$fn->redirect('forgot-password.php'):$fn->getSession('email')?></span>
                </div>
                <div class="form-floating mb-4">
                    <input type="text" name="password" required class="form-control" id="floatingEmail" placeholder="name@example.com">
